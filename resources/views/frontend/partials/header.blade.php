		...
		<nav class="menu-top">
			<div class="container">
				<ul class="nav-menu">
					...
					<li class="level0 @if( ( $routeName == "news-list" || $routeName == "news-detail" ) && isset($cateDetail) && $cateDetail->slug == "lam-dep-cung-co-dau" ) active @endif""><a href="{!! route('news-list', 'lam-dep-cung-co-dau') !!}" title="Làm đẹp cùng cô dâu">LÀM ĐẸP CÙNG CÔ DÂU</a></li>
